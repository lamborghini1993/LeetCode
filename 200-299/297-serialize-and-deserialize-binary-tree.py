...
#     def _find_max_layer(self, root: TreeNode) -> int:
#         max_layer = 0
...
#         if not root:
#             return "[]"
#         num = 2 ** self._find_max_layer(root) - 1
...
#             if node.left:
#                 queue.put(((index << 1) + 1, node.left))
#             if node.right:
#                 queue.put(((index << 1) + 2, node.right))
...
#             index, node = queue.get()
#             l = (index << 1) + 1
#             if l < len(lst) and lst[l] is not None:
#                 left = TreeNode(lst[l])
#                 node.left = left
#                 queue.put((l, left))

#             r = (index << 1) + 2
#             if r < len(lst) and lst[r] is not None:
